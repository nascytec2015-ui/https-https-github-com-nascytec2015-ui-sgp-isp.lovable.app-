          ...
          <CardContent className="p-0">
            <div className="relative bg-slate-950">
              ...
              <svg
                ...
                className="w-full min-h-[560px] h-[72vh] touch-none select-none"
              ...
              >
                ...
                <rect width={CANVAS_W} height={CANVAS_H} fill="hsl(222 47% 7%)" />
                <rect width={CANVAS_W} height={CANVAS_H} fill="url(#grid)" opacity="0.75" />

                {/* imported SVG background (tracing layer) */}
                {diagram.background && (
                  <image
                    href={diagram.background}
                    x="0"
                    y="0"
                    width={CANVAS_W}
                    height={CANVAS_H}
                  ...
                  return (
                    ...
                    >
                      ...
                      <text
                        ...
                        fontWeight="600"
                      >
                        {rxB !== undefined ? rxB.toFixed(2) + " dBm" : "—"}
                      </text>
                    </g>
                  );
                })}
                ...
                {diagram.nodes.map((n) => {
                  ...
                  const conf = n.recog_confidence;
                  const hasIssues = (n.recog_issues?.length ?? 0) > 0;
                  const needsReview = conf !== undefined && (conf < 0.7 || hasIssues);
                  const ringColor = needsReview ? confColor(conf) : null;
                  return (
                    <g
                      key={n.id}
                      ...
                      style={{ cursor: linkFrom ? "crosshair" : "move" }}
                    >
                      {ringColor && (
                        <rect
                          x={-5}
                      ...
                      <rect
                        ...
                        opacity={0.92}
                        stroke={
                          isSel || isLinkSrc ? "hsl(var(--primary))" : "hsl(var(--background))"
                        }
                      ...
                      {hasIssues && (
                        <g transform={`translate(${-12}, ${-12})`}>
                          <circle r="9" fill="hsl(0 75% 55%)" stroke="white" strokeWidth="1.5" />
                          <text
                            x="0"
                            y="3"
                            textAnchor="middle"
